...
const Footer = () => {
  ...
  return (
    <footer className="bg-black py-8 relative overflow-hidden border-t border-gray-800">
      ...
      <div className="container mx-auto px-6 text-center text-gray-400 text-sm">
        ...
        <div className="flex justify-center space-x-4 mt-4">
          <a href="mailto:francelinomelvyn@gmail.com" target="_blank" rel="noonpener noreferrer" className="hover:text-white transition-colors duration-300">Email</a>
