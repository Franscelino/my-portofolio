...
import { Download, ExternalLink } from 'lucide-react'; // Import Download and ExternalLink icons
                ...
                <div className="max-w-6xl mx-auto">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-16">
                        {allProjectsData.map((item, index) => (
                            ...
                            <Link
                                key={item.id}
                                to={`/projects/${item.id}`} // Dynamic link to project detail page
                                className="group relative bg-gray-900/40 backdrop-blur-sm rounded-2xl p-6 border border-gray-700/50 hover:border-purple-500/50 transition-all duration-500 hover:shadow-2xl hover:shadow-purple-500/10 hover:-translate-y-2 flex flex-col" // Added flex flex-col here
                            ...
                            >
                                ...
                                <div className="flex flex-wrap justify-end space-x-4">
                                    {item.repositoryLink && (
                                        ...
                                        >
                                            {/* Using inline SVG for consistency */}
                                    ...
                                    {item.paperDownloadLink && (
                                        <a
                                            ...
                                            target="_blank"
                                            rel="noopener noreferrer"
                                            className="inline-flex items-center px-4 py-2 bg-gradient-to-r from-teal-600 to-blue-600 border border-teal-500/30 text-white text-sm font-medium rounded-lg transition-all duration-300 hover:from-teal-500/20 hover:to-blue-600/20 hover:border-teal-400 hover:shadow-lg hover:shadow-teal-500/20 active:scale-95"
                                            onClick={(e) => e.stopPropagation()} // Prevent parent Link from triggering
                                        >
                    ...
                    <div className="text-center">
                        {/* "Explore All Projects" button now links to the project summary page */}
                        <Link
