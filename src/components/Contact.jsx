...
import { MapPin } from 'lucide-react'; // Memastikan MapPin diimpor jika digunakan

const Contact = () => {
  // Efek untuk menggulir ke bagian atas halaman saat komponen dimuat
  useEffect(() => {
    window.scrollTo(0, 0);
  }, []);
  ...
  const contactInfo = [
    ...
    },
    {
      ...
      link: 'https://www.instagram.com/franscelinomelvynn',
      icon: (
    ...
    },
    {
      ...
      link: 'https://www.linkedin.com/in/franscelino-melvyn-5874a1292',
      icon: (
    ...
    },
    {
      name: 'GitHub',
      value: 'Franscelino',
      link: 'https://github.com/Franscelino',
      icon: (
        <svg className="w-6 h-6 text-orange-400 group-hover:text-white transition-colors duration-300" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
    ...
    },
    {
      name: 'Discord',
      value: 'melvyn18',
      link: 'https://discordapp.com/users/melvyn18',
      icon: (
        <svg className="w-6 h-6 text-purple-400 group-hover:text-white transition-colors duration-300" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
    ...
    <section id="contact" className="py-24 bg-black relative overflow-hidden section-padding">
      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-base md:text-lg text-gray-300 mb-8 md:mb-12 leading-relaxed px-4"> {/* Adjusted font size and padding */}
            Feel free to reach out to me through any of the platforms below!
          </p>

          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8"> {/* Adjusted gap */}
            {contactInfo.map((item, index) => (
              <a
                ...
                className="card-base p-4 sm:p-6 hover:shadow-lg relative overflow-hidden flex flex-col items-center justify-center text-center"
              >
                ...
                <div className="relative mb-3 sm:mb-4 p-2 sm:p-3 rounded-full bg-gray-800 group-hover:bg-gradient-to-r group-hover:from-purple-500 group-hover:to-orange-500 transition-all duration-300"> {/* Adjusted padding */}
                  {item.icon}
                </div>
                <h3 className="relative text-lg sm:text-xl font-semibold text-white mb-1 sm:mb-2 group-hover:text-white transition-colors duration-300"> {/* Adjusted font size */}
                  {item.name}
                </h3>
                <p className="relative text-sm sm:text-base text-gray-300 group-hover:text-white transition-colors duration-300"> {/* Adjusted font size */}
                  {item.value}
                </p>
              </a>
            ))}
