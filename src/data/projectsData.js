...
const allProjectsData = [
    {
        ...
        imageUrl: '/Nexpathlanding.png', 
        thumbnailUrl: '/Nexpathlanding.png', 
        ...
        gallery: [
            { url: '/Nextpathdashboard.png', caption: 'Nextpath Dashboard', description: 'Personalized user dashboard with career insights.' }, 
            { url: '/Nextpathchatbot.png', caption: 'AI Chatbot Feature', description: 'Interactive AI chatbot for instant career guidance.' }, 
            { url: '/articles.png', caption: 'Career Articles Section', description: 'Curated articles providing industry knowledge and trends.' }, 
            { url: '/Nextpathgoal.png', caption: 'Personalized Goals Tracking', description: 'Feature to set and monitor career development goals.' } 
        ]
    },
    {
        id: 'clovio-online-fashion-store',
        name: 'Clovio - E-commerce Fashion Store',
        imageUrl: '/Clovio1.jpg', 
        thumbnailUrl: '/Clovio1.jpg', 
        ...
        gallery: [
            { url: '/Clovio1.jpg', caption: 'Clovio Homepage', description: 'The Main View of Landing Page.' }, 
            { url: '/Clovio2.jpg', caption: 'Login Register Page', description: 'User login and registration page.' }, 
            { url: '/Clovio3.jpg', caption: 'Category Page', description: 'Summary of product categories.' }, 
            { url: '/Clovio4.jpg', caption: 'Catalog Page', description: 'Product catalog view for admin.' }, 
            { url: '/Clovio5.jpg', caption: 'Order History', description: 'User order history view.' }, 
            { url: '/Clovio6.jpg', caption: 'Shopping Cart Page', description: 'Checkout process with order summary.' }, 
            { url: '/Clovio7.jpg', caption: 'Checkout Page', description: 'Checkout page with order summary.' }, 
            { url: '/Clovio8.jpg', caption: 'Admin Dashboard', description: 'Admin dashboard for managing products and orders.' } 
        ]
    },
    {
        id: 'whatage-website',
        name: 'WhatAge Website',
        imageUrl: '/whatage1.png', 
        thumbnailUrl: '/whatage1.png', 
        ...
        gallery: [
            { url: '/whatage1.png', caption: 'Homepage with upload interface' }, 
            { url: '/whatage2.png', caption: 'Prediction result display' }, 
            { url: '/whatage3.png', caption: 'Mobile view responsiveness' }, 
            { url: '/whatage4.png', caption: 'Mobile view responsiveness' } 
        ]
    },
    {
        ...
        imageUrl: '/ethsol1.png', 
        thumbnailUrl: '/ethsol1.png', 
        ...
        gallery: [
            { url: '/ethsol2.png', caption: 'Performance Comparison - Sequential Transactions', description: 'Combined visualization of TPS, Latency, and Gas Fee for sequential transactions on Ethereum and Solana (Fig. 1).' }, 
            { url: '/ethsol3.png', caption: 'Performance Comparison - Parallel Transactions', description: 'Combined visualization of TPS, Latency, and Gas Fee for parallel transactions on Ethereum and Solana (Fig. 2).' }, 
            { url: '/ethsol4.png', caption: 'Transaction-level Latency and Gas Fee - Sequential', description: 'Transaction-level comparison of latency and gas fees for Ethereum and Solana in sequential execution (Fig. 3).' }, 
            { url: '/ethsol5.png', caption: 'Distribution of Solana Leaders', description: 'Bar chart showing the distribution of block proposers on the Solana network (Fig. 4).' }, 
            { url: '/ethsol6.png', caption: 'Distribution of Ethereum Proposers', description: 'Bar chart illustrating the distribution of block proposers on the Ethereum network (Fig. 5).' }, 
            { url: '/ethsol7.png', caption: 'Block Delay Time Comparison: Ethereum vs Solana', description: 'Line graph comparing block delay times between Ethereum and Solana (Fig. 6).' }, 
            { url: '/ethsol8.png', caption: 'Average TTA & TTP of Incidents: Solana vs Ethereum', description: 'Bar chart comparing the average Time to Acknowledge (TTA) and Time to Patch (TTP) for security incidents on Solana and Ethereum (Fig. 7a).' }, 
            { url: '/ethsol9.png', caption: 'Average Incident Transparency: Solana vs Ethereum', description: 'Bar chart illustrating the average incident transparency levels for Solana and Ethereum (Fig. 7b).' } 
        ]
    },
    {
        id: 'Buka-Pajak',
        name: 'Buka Pajak - Tax Filing Web Application',
        imageUrl: '/BukaPajak1.png',
        thumbnailUrl: '/BukaPajak1.png',
        repositoryLink: 'https://github.com/BRYAN1309/Hology-Software-Development.git',
        liveDemoLink: null,
        shortDetails: [
            'Web application for simplified tax filing and management.',
            'Features user authentication, tax form generation, and payment integration.',
        ],
        fullDescription: `Buka Pajak is a web application designed to streamline the tax filing process for individuals and businesses. The platform offers a user-friendly interface for managing tax documents, generating tax forms, and submitting filings electronically. Key features include secure user authentication, automated tax calculations, and integration with payment gateways for seamless tax payments. Built with modern web technologies, Buka Pajak ensures data security and compliance with local tax regulations. This project showcases skills in full-stack development, API integration, and user experience design.`,
        technologies: ['React', 'Node.js', 'Express', 'MongoDB', 'RESTful APIs', 'OAuth', 'Payment Integration'],
        features: [
        ...
        challenges: [
            'Ensuring data security and compliance with tax regulations',
            'Integrating with third-party payment gateways',
            'Handling complex tax calculation logic',
        ],
        learnings: [
            'Gained experience in full-stack web development',
            'Learned best practices for secure user authentication',
        ],
        gallery: [
            { url: '/BukaPajak2.png', caption: 'BukaPajak Owner POV', description: 'Page from BukaPajak Owner POV.' }, 
            { url: '/BukaPajak3.png', caption: 'BukaPajak Proposer POV', description: 'Page from BukaPajak Proposer POV.' }, 
            { url: '/BukaPajak4.png', caption: 'BukaPajak Upload Proposal', description: 'Page from BukaPajak Upload Proposal.' }, 
            { url: '/BukaPajak5.png', caption: 'BukaPajak Auditor POV', description: 'Page from BukaPajak Auditor POV.' } 
        ]
    },
    {
        ...
        gallery: [
            { url: '/vote1.png', caption: 'DApp Main View', description: 'Homepage of the voting system.' }, 
            { url: '/vote2.png', caption: 'Voting Details and Options', description: 'Poll details and available options.' }, 
            { url: '/vote3.png', caption: 'Poll Creation Form', description: 'Interface for creating a new poll.' }, 
            { url: '/vote4.png', caption: 'MetaMask Transaction Confirmation', description: 'MetaMask pop-up for transaction confirmation.' }, 
            { url: '/vote5.png', caption: 'Poll Results Display (Bar Chart)', description: 'Visual representation of voting results after the poll ends.' }, 
            { url: '/vote6.png', caption: 'Poll Results Display (Percentages)', description: 'Voting results with percentages for each option.' }, 
            { url: '/vote7.png', caption: 'User Voting Status', description: 'Indication of whether the user has voted.' }, 
            { url: '/vote8.png', caption: 'Error/Success Messages', description: 'Notifications to the user about operation status.' }, 
            { url: '/vote9.png', caption: 'Responsive Design (Mobile)', description: 'DApp interface optimized for mobile devices.' } 
        ]
    },
    {
        ...
        gallery: [
            { url: '/age1.png', caption: 'Model Performance Comparison (MAE)', description: 'Mean Absolute Error comparison across XGBoost, CatBoost, and TabNet for age prediction.' }, 
            { url: '/age2.png', caption: 'Feature Importance - XGBoost', description: 'Visualization of key features influencing XGBoost age predictions.' }, 
            { url: '/age3.png', caption: 'Feature Importance - CatBoost', description: 'Visualization of key features influencing CatBoost age predictions.' }, 
            { url: '/age4.png', caption: 'TabNet Attentive Transformer Output', description: 'Illustrating TabNet\'s attention mechanism on input features.' }, 
