...
import {
    ...
    Play, TrendingUp, BookOpen, Code, Briefcase, ChevronRight,
    Link as LinkIcon
} from 'lucide-react';
...
const HardSkillsExperiencePage = () => {
    ...
    const iconComponents = {
        BookOpen, Users, Camera, Lightbulb, Zap, LinkIcon, Award, TrendingUp, Code, Briefcase,
    };
    ...
    return (
        <>
            ...
            <section id="hard-skills-experience-detail" className="py-16 sm:py-24 relative overflow-hidden min-h-screen section-padding" style={{ backgroundColor: 'var(--color-bg-primary)' }}>
                <div className="max-w-7xl mx-auto px-4 sm:px-6 relative z-10">
                    ...
                    <div className="text-center mb-16 sm:mb-20">
                        <p className="text-eyebrow mb-4">Technical training</p>
                        <h1 className="text-4xl sm:text-5xl md:text-6xl font-black text-white mb-4 sm:mb-6 tracking-wide">
                            <span style={{ color: 'var(--color-accent)' }}>Hard Skill</span> Experiences
                        </h1>
                            ...
                            return (
                                <div
                                    ...
                                    style={{
                                        ...
                                        borderColor: exp.status === 'ongoing' ? 'rgba(0, 229, 255, 0.3)' : undefined,
                                    }}
                                >
                                    {/* Ongoing badge */}
                                    {exp.status === 'ongoing' && (
                                    ...
                                    <div className="relative z-10">
                                        <div className="flex items-center mb-4 sm:mb-6">
                                            ...
                                            <div className="flex-1">
                                                ...
                                                {exp.company && <p className="text-sm font-medium mb-1" style={{ color: 'var(--color-accent)' }}>{exp.company}</p>}
