                    ...
                    <div className="container mx-auto px-6 relative z-10">
                        <div className="max-w-4xl mx-auto bg-gray-900/40 rounded-xl p-8 md:p-12 border border-gray-700 shadow-2xl">
                            ...
                            {project.fullDetails && (
                                <div className="mb-10">
                                    ...
                                    <div className="text-lg text-gray-300 leading-relaxed space-y-4">
                                        {project.fullDetails.map((block, index) => {
                                            if (block.type === 'paragraph') {
                                                return <p key={index}>{block.content}</p>;
                                            } else if (block.type === 'heading') {
                                                return <h3 key={index} className="text-2xl font-semibold text-white mt-6 mb-3">{block.content}</h3>;
                            ...
                            {project.features && project.features.length > 0 && (
                                <div className="mb-10">
                                    <h2 className="text-3xl font-bold text-white mb-4 flex items-center">
                                        <Star className="w-6 h-6 mr-3 text-yellow-400" /> Key Findings
                                    </h2>
                            ...
                            {project.technologies && project.technologies.length > 0 && (
                                <div className="mb-10">
                                    <h2 className="text-3xl font-bold text-white mb-4 flex items-center">
                                        <Code className="w-6 h-6 mr-3 text-cyan-400" /> Technologies & Tools
                                    </h2>
                            ...
                            {project.learnings && project.learnings.length > 0 && (
                                <div className="mb-10">
                                    <h2 className="text-3xl font-bold text-white mb-4 flex items-center">
                                        <Lightbulb className="w-6 h-6 mr-3 text-yellow-400" /> Learnings & Future Work
                                    </h2>
                                    <ul className="list-none space-y-3 text-gray-300">
                            ...
                            {project.gallery && project.gallery.length > 0 && (
                                <div className="mb-10">
                                    <h2 className="text-3xl font-bold text-white mb-6 flex items-center">
                                        <Camera className="w-6 h-6 mr-3 text-blue-400" /> Key Figures
                                    </h2>
